...
let favoriteFoods = ['kadhi pakora', 'mangoes', 'grilled cheese', 'butternut squash soup']
...
favoriteFoods.unshift('coffee ice cream');
...
//     log both the food removed and the updated array
let dessertsDoNotCount = favoriteFoods.shift();
console.log('Removed the first food', dessertsDoNotCount);
console.log('My favorite foods are now:', favoriteFoods);

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
favoriteFoods.slice(1,1, 'peaches');
console.log('My favorite foods are now:', favoriteFoods);
...
console.log('My favorite foods are sorted:', favoriteFoods);
...
console.log('Array with food and animals:', foodAndAnimals);